...
const MainTitle = memo(() => (
  <div className="space-y-2" data-aos="fade-up" data-aos-delay="600">
    <p className="text-lg sm:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed" data-aos="fade-up" data-aos-delay="800">
      I'm a passionate Java Developer with expertise in Data Structures, Algorithms, and Web Development. 
      Currently pursuing Electronics and Communication Engineering at BMS Institute of Technology and Management.
    </p>
...
const WORDS = ["Java Developer", "Problem Solver", "Web Developer"];
const TECH_STACK = ["Java", "Data Structures", "Algorithms", "React", "JavaScript"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Charanhy" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/charan-hy-3711a6276" },
  { icon: Mail, link: "mailto:charanyograj@gmail.com" },
];
