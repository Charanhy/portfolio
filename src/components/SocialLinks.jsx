...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/charan-hy-3711a6276",
    color: "#0A66C2",
    ...
    <div className="relative flex items-center justify-center w-12 h-12">
      <div 
        className={`absolute inset-0 rounded-md transition-all duration-500
                   group-hover:scale-110 opacity-20 group-hover:opacity-30 ${linkedIn.gradient}`}
        style={{ backgroundColor: linkedIn.color }}
      />
      <div className="relative p-2 rounded-md">
        {renderIcon(linkedIn.icon, 'white')}
      </div>
    </div>
